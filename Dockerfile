...
ARG IMAGE_COMPONENT="ovs-operator-container"
ARG IMAGE_NAME="ovs-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Open vSwitch Operator"
ARG IMAGE_DESC="This image includes the ovs-operator"
...
ENV USER_UID=$USER_ID \
    OPERATOR_TEMPLATES=/usr/share/ovs-operator/templates/
